...
from src.model_detection import Model
from src.dataset_detection import Sketchy
...
if __name__ == '__main__':
    ...
    val_dataset = Sketchy(opts, dataset_transforms, mode='val', return_orig=False)

    train_loader = DataLoader(dataset=train_dataset, batch_size=opts.batch_size,
        num_workers=opts.workers, collate_fn=Sketchy.collate_fn)

    val_loader = DataLoader(dataset=val_dataset, batch_size=opts.batch_size,
        num_workers=opts.workers, collate_fn=Sketchy.collate_fn)
